...
#'- Model validation - Pearson Correlation
  ...
  cms_val <- ggplot() + 
    geom_point(aes(as.vector(predict(CMS_full)), CMS_dat$CMS_prop)) + 
...
#'- Extract 95% CI  
  ...
  row2 <- row.names(CMS_full_coef) %in% c('scale(CRC_prop)')
  row3 <- row.names(CMS_full_coef) %in% c('scale(Area)')
  row4 <- row.names(CMS_full_coef) %in% c('scale(Per_Agriculture)')
  row5 <- row.names(CMS_full_coef) %in% c('scale(Elevation)')
  row6 <- row.names(CMS_full_coef) %in% c('scale(resid_Temp)')
  
  lower0 <- CMS_full_coef[row0,'Estimate'] - 1.96*CMS_full_coef[row0, 'Cond. SE']
  upper0 <- CMS_full_coef[row0,'Estimate'] + 1.96*CMS_full_coef[row0, 'Cond. SE']
  
  lower1 <- CMS_full_coef[row1,'Estimate'] - 1.96*CMS_full_coef[row1, 'Cond. SE']
  upper1 <- CMS_full_coef[row1,'Estimate'] + 1.96*CMS_full_coef[row1, 'Cond. SE']
  
  lower2 <- CMS_full_coef[row2,'Estimate'] - 1.96*CMS_full_coef[row2, 'Cond. SE']
  upper2 <- CMS_full_coef[row2,'Estimate'] + 1.96*CMS_full_coef[row2, 'Cond. SE']
  
  lower3 <- CMS_full_coef[row3,'Estimate'] - 1.96*CMS_full_coef[row3, 'Cond. SE']
  upper3 <- CMS_full_coef[row3,'Estimate'] + 1.96*CMS_full_coef[row3, 'Cond. SE']

  lower4 <- CMS_full_coef[row4,'Estimate'] - 1.96*CMS_full_coef[row4, 'Cond. SE']
  upper4 <- CMS_full_coef[row4,'Estimate'] + 1.96*CMS_full_coef[row4, 'Cond. SE']
  
  lower5 <- CMS_full_coef[row5,'Estimate'] - 1.96*CMS_full_coef[row5, 'Cond. SE']
  upper5 <- CMS_full_coef[row5,'Estimate'] + 1.96*CMS_full_coef[row5, 'Cond. SE']
  
  lower6 <- CMS_full_coef[row6,'Estimate'] - 1.96*CMS_full_coef[row6, 'Cond. SE']
  upper6 <- CMS_full_coef[row6,'Estimate'] + 1.96*CMS_full_coef[row6, 'Cond. SE']
...
#'- Model validation - Pearson Correlation
  ...
  srd_val <-ggplot() + 
    geom_point(aes(as.vector(predict(SRD_full)), SRD_dat$SRD_prop)) + 
...
#'- Extract 95% CI  
  ...
  row2 <- row.names(SRD_full_coef) %in% c('scale(CRC_prop)')
  row3 <- row.names(SRD_full_coef) %in% c('scale(CSR_prop)')
  row4 <- row.names(SRD_full_coef) %in% c('scale(Area)')
  row5 <- row.names(SRD_full_coef) %in% c('scale(Per_Agriculture)')
  row6 <- row.names(SRD_full_coef) %in% c('scale(Elevation)')
  row7 <- row.names(SRD_full_coef) %in% c('scale(resid_Temp)')
  
  lower0 <- SRD_full_coef[row0,'Estimate'] - 1.96*SRD_full_coef[row0, 'Cond. SE']
  upper0 <- SRD_full_coef[row0,'Estimate'] + 1.96*SRD_full_coef[row0, 'Cond. SE']
  
  lower1 <- SRD_full_coef[row1,'Estimate'] - 1.96*SRD_full_coef[row1, 'Cond. SE']
  upper1 <- SRD_full_coef[row1,'Estimate'] + 1.96*SRD_full_coef[row1, 'Cond. SE']
  
  lower2 <- SRD_full_coef[row2,'Estimate'] - 1.96*SRD_full_coef[row2, 'Cond. SE']
  upper2 <- SRD_full_coef[row2,'Estimate'] + 1.96*SRD_full_coef[row2, 'Cond. SE']
  
  lower3 <- SRD_full_coef[row3,'Estimate'] - 1.96*SRD_full_coef[row3, 'Cond. SE']
  upper3 <- SRD_full_coef[row3,'Estimate'] + 1.96*SRD_full_coef[row3, 'Cond. SE']
  
  lower4 <- SRD_full_coef[row4,'Estimate'] - 1.96*SRD_full_coef[row4, 'Cond. SE']
  upper4 <- SRD_full_coef[row4,'Estimate'] + 1.96*SRD_full_coef[row4, 'Cond. SE']
  
  lower5 <- SRD_full_coef[row5,'Estimate'] - 1.96*SRD_full_coef[row5, 'Cond. SE']
  upper5 <- SRD_full_coef[row5,'Estimate'] + 1.96*SRD_full_coef[row5, 'Cond. SE']
  
  lower6 <- SRD_full_coef[row6,'Estimate'] - 1.96*SRD_full_coef[row6, 'Cond. SE']
  upper6 <- SRD_full_coef[row6,'Estimate'] + 1.96*SRD_full_coef[row6, 'Cond. SE']
  
  lower7 <- SRD_full_coef[row7,'Estimate'] - 1.96*SRD_full_coef[row7, 'Cond. SE']
  upper7 <- SRD_full_coef[row7,'Estimate'] + 1.96*SRD_full_coef[row7, 'Cond. SE']
